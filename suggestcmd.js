...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("Usage", "TC!suggestcmd <suggestion>", true)
    .addField("Example", "TC!suggestcmd A derp command")
    ...
    .setColor("#303fc9")
    .setDescription("New Command Suggestion!")
    .setAuthor(message.author.username)
    .addField("Suggestion", suggestionMessage)
    .addField("Suggested by", `${message.author.username}`)
    .setFooter(`TCBot Command Suggestion from ${message.author.username}`)
